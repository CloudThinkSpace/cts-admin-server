use crate::{manager::sys::sys_tenant::SysTenant, TableOperation};
...
impl TableOperation for Project {
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(Project::Total)
                            .integer()
                            .not_null()
                            .default(0),
                    )
                    .col(
                        ColumnDef::new(Project::Type)
                            .integer()
                            .not_null()
                            .default(0),
                    )
                    ...
                    .col(ColumnDef::new(Project::TenantId).string().not_null())
    ...
    async fn create_index(&self, manager: &SchemaManager<'_>) -> Result<(), DbErr> {
        ...
        manager
            .create_foreign_key(
                ForeignKey::create()
                    .name("FK-project_tenant_id")
                    .from(Project::Table, Project::TenantId)
