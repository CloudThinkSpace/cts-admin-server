...
fn create_data() -> Vec<[Value; 10]> {
    ...
    let data_project: [Value; 10] = [
        ...
        7.into(),
        "/project/index".into(),
        "/cts/project/index.vue".into(),
        "项目管理".into(),
        false.into(),
        now.into(),
    ];
    // 任务数据
    let data_task: [Value; 10] = [
        "8".into(),
        "task".into(),
        "ic:baseline-article".into(),
        "6".into(),
        8.into(),
        "/task/index/:id".into(),
        "/cts/task/index.vue".into(),
        "任务列表".into(),
        false.into(),
        now.into(),
    ];
    // 数据数据
    let data_form: [Value; 10] = [
        "9".into(),
        "form".into(),
        "ic:baseline-article".into(),
        "6".into(),
    ...
    result.push(data_task);
    result.push(data_form);
